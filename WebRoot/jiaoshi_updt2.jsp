...
<link rel="stylesheet" href="images/hsgcommon/common.css" type="text/css">
	...
	<body>
			<form action="updateJiaoshi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改教师<input type="hidden" name="id" value="${jiaoshi.id}" /></td>
						</tr>
		...
		<tr ><td width="200">备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu' onblur='' class="form-control" style="width:600px; height:80px;" ></textarea></td></tr>
						...
						<script language="javascript">document.form1.gonghao.value='${jiaoshi.gonghao}';</script>
	<script language="javascript">document.form1.mima.value='${jiaoshi.mima}';</script>
	<script language="javascript">document.form1.xingming.value='${jiaoshi.xingming}';</script>
	<script language="javascript">document.form1.xingbie.value='${jiaoshi.xingbie}';</script>
	<script language="javascript">document.form1.nianling.value='${jiaoshi.nianling}';</script>
	<script language="javascript">document.form1.shenfenzheng.value='${jiaoshi.shenfenzheng}';</script>
	<script language="javascript">document.form1.dianhua.value='${jiaoshi.dianhua}';</script>
	<script language="javascript">document.form1.zhicheng.value='${jiaoshi.zhicheng}';</script>
	<script language="javascript">document.form1.beizhu.value='${jiaoshi.beizhu}';</script>
