...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateGerenxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改个人信息<input type="hidden" name="id" value="${gerenxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.gonghao.value='${gerenxinxi.gonghao}';</script>	<script language="javascript">document.form1.xingming.value='${gerenxinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${gerenxinxi.xingbie}';</script>	<script language="javascript">document.form1.nianling.value='${gerenxinxi.nianling}';</script>	<script language="javascript">document.form1.shengao.value='${gerenxinxi.shengao}';</script>	<script language="javascript">document.form1.tizhong.value='${gerenxinxi.tizhong}';</script>	<script language="javascript">document.form1.xueya.value='${gerenxinxi.xueya}';</script>	<script language="javascript">document.form1.shentiyichangqingkuang.value='${gerenxinxi.shentiyichangqingkuang}';</script>	<script language="javascript">document.form1.beizhu.value='${gerenxinxi.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
