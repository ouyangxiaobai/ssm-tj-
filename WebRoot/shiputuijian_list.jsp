...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">食谱推荐列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shiputuijianList.do" name="myform" method="post">
									查询   工号：<input name="gonghao" type="text" id="gonghao" class="form-control2" />  姓名：<input name="xingming" type="text" id="xingming" class="form-control2" />
  ...
  %>>
                             ...
                             <td>${u.gonghao}</td>    <td>${u.xingming}</td>                                    
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateShiputuijian.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteShiputuijian.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="shiputuijianDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="shiputuijianList.do?page=1" >首页</a>
             <a href="shiputuijianList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shiputuijianList.do?page=${page.page+1 }">下一页</a>
			<a href="shiputuijianList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
